set(DIGIT_TWIN_TEST_NAME TurbineGovernorTypeI)				#Naziv prvog projekta u solution-u
...
file(GLOB DIGIT_TWIN_TEST_INC_CNT  ${NATID_SDK_INC}/cnt/*.h)
file(GLOB DIGIT_TWIN_TEST_INC_SC  ${NATID_SDK_INC}/sc/*.h)
file(GLOB DIGIT_TWIN_TEST_INC_TD  ${NATID_SDK_INC}/td/*.h)
file(GLOB DIGIT_TWIN_TEST_INC_THREAD  ${NATID_SDK_INC}/thread/*.h)
file(GLOB DIGIT_TWIN_TEST_INC_GUI ${NATID_SDK_INC}/gui/*.h)
...
target_include_directories(${DIGIT_TWIN_TEST_NAME} PRIVATE ${CMAKE_CURRENT_LIST_DIR}/src)
...
target_link_libraries(${DIGIT_TWIN_TEST_NAME} debug ${MU_LIB_DEBUG} debug ${NATGUI_LIB_DEBUG} debug ${MATRIX_LIB_DEBUG} debug ${SYMBCOMP_LIB_DEBUG}
										optimized ${MU_LIB_RELEASE} optimized ${NATGUI_LIB_RELEASE} optimized ${MATRIX_LIB_RELEASE} optimized ${SYMBCOMP_LIB_RELEASE})
